...
| **vi** | Mídia Paga (Google e Meta) | [G](checklist-dados-e-acessos.md#-g-mídia-paga-google-e-meta--prioritário) | 10–21 set | 🟠 Médio, mapa de contas e finalidade de cada uma | Exposição · Atenção · Qualificação · **Cegueira** |

> ✅ **A camada de plataforma de (vi) fechou em 16/09**, com o export direto das 5 contas de Google Ads da MCC do Viva Real. [Leitura](diagnostico-vi-midia-paga.md). O diagnóstico **não fecha inteiro**: falta o relatório de ações de conversão, o export direto do Meta e a parcela de impressões. A trava que ele mais move não é nenhuma das três previstas, é a **Cegueira**.
