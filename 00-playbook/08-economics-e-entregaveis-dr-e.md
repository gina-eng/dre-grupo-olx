...
> e **diverge** do padrão em valor e em critério de bônus.

## 1. Entregáveis padrão DR-E

| Entregável | Quantidade/ano | Condução |
|---|---|---|
| Mapeamento do Fluxo de Receita + diagnóstico completo das travas | 4 | Matriz |
| Plano de Ação Trimestral (90 dias) | 4 | Matriz |
| Board de Decisão Online | 8 | Matriz |
| **Boards de Decisão Presenciais** | **4** | C-Level V4 |
| Pesquisa de Mercado e Benchmark | ✔ | Matriz / V4 Marketing |
...
- *Posicionamento Estratégico:* Diferenciais Competitivos · PUV · SWOT · ICPs · Fluxo de Estratégia · Matriz de Priorização Esforço × Impacto
- *LTP & Solução:* CRT · Nuvem de Conflito · Injeção + FRT
- *Planejamento:* Plano de 90 dias (PRT + TT) · Forecasting 12 meses · Preparação da matriz de expansão

## 2. Perfil de cliente

| Elegível | Inelegível |
|---|---|
| Operação digital madura e previsível; investe milhões em mídia; quer escala, M&A ou valuation; ambição de liderança de mercado | Quem busca apenas otimização incremental sem apetite para mudanças estruturais |
...
| **DR-E** | **R$ 350.000/ano** | **R$ 250.000 fixo + R$ 250.000 bônus** |

### Modelo de bônus (Opção B)
- **Gatilho:** expansão comprovada de **2 das 8 travas** ao longo dos 4 ciclos anuais.
- **Prazo:** D+370 dias do início do contrato.
...
### Garantia padrão (SOW)
Garantia condicional em até **60 dias** (DR-O/T/E), desde que cumulativamente: (i) participação em
todos os encontros; (ii) envio tempestivo de todos os dados; (iii) solicitação baseada na **não
...
| Papel | Ciclo 1 | Ciclos 2/3/4 | Total/ano | Custo/hora |
|---|---|---|---|---|
| Consultor (unidade) | 68h | 32h | 164h | R$ 62,50 |
...
| | Ciclo 1 | Ciclos 2/3/4 |
|---|---|---|
| CSP Overhead | R$ 893,75 | R$ 343,75 |
| CSP Direto | R$ 4.250,00 | R$ 2.000,00 |
| GP (Matriz) | R$ 843,75 | R$ 843,75 |
| C-Level (Matriz) | R$ 16.875,00 | R$ 16.875,00 |
| **Total** | **R$ 22.862,50** | **R$ 20.062,50** |

### P&L de referência (faturamento mínimo R$ 263.847,50/ano)
...
## 5. Fora de escopo (todos os níveis)

Execução de marketing/tráfego/conteúdo · body shop · garantia de resultado de vendas ·
otimização simultânea de múltiplos pontos · mentoria individual ou treinamento ·
refação/customização/personalização dos artefatos (fornecidos conforme padrão metodológico).
