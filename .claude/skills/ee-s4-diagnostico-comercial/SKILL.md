...
Gere o output COMPLETO de uma vez usando os dados de `dados/client.json` (briefing, connectors), outputs de skills dependentes, e dados do funil informados pelo operador.
...
1. Salve em `dados/outputs/ee-s4-diagnostico-comercial.json` (com campo `summary` no topo)
