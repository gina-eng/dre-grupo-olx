...
Gere o output COMPLETO de uma vez: perfil do comprador + script da simulação. Use os dados de `dados/client.json` (briefing) e outputs de skills dependentes em `dados/outputs/`.
...
1. Salve em `dados/outputs/ee-s4-cliente-oculto.json` (com campo `summary` no topo)
