...
Gere o output COMPLETO de uma vez após receber os criativos do operador. Use os dados de `dados/client.json` (briefing) e outputs de skills dependentes em `dados/outputs/`.
...
1. Salve em `dados/outputs/ee-s2-diagnostico-criativos.json` (com campo `summary` no topo)
