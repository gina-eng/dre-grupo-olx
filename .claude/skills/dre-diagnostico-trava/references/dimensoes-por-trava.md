# Dimensoes de score e entrada visual por trava
...
| | Dimensao |
|---|---|
| A | Existencia de dados basicos (lead, cliente, receita separados) |
| B | CAC calculado e confiavel |
| C | LTV e payback calculados |
...
| | Dimensao |
|---|---|
| A | CTR / resposta inicial |
| B | Diferenciacao |
| C | Clareza da promessa |
| D | Forca de interrupcao |
| E | Competitividade |
...
| | Dimensao |
|---|---|
| A | Tempo de permanencia |
| B | Estrutura narrativa |
| C | Educacao e diagnostico |
| D | Provas e diferenciacao |
| E | Sustentacao do engajamento |

**Sintomas:** rejeicao alta; permanencia baixa; scroll raso; baixo consumo de conteudo; leads que somem apos o primeiro material; oferta antes da construcao de valor.
...
| C | Alinhamento ICP vs. clientes |
| D | Processo de qualificacao |
...
| | Dimensao |
|---|---|
| A | Tempo ate o 1o contato |
| B | Conversao para agendamento |
| C | Taxa de comparecimento |
| D | Cadencia e qualidade do follow-up |
...
| | Dimensao |
|---|---|
| A | Dados estruturados de retencao |
| B | Receita recorrente relevante |
| C | Jornada formal de pos-venda |
| D | Politica clara de continuidade |
| E | Estrategia ativa de expansao |

**Nota acima de 3 exige evidencia formal.**
**Sintomas:** recorrencia irrelevante; alto percentual de one-shot; churn elevado ou nao medido; LTV proximo ou inferior ao CAC; pos-venda informal.
**Entrada visual obrigatoria:** Scorecard de Retencao por produto (receita recorrente %, recompra %, permanencia media, LTV) + cohort.
**Ferramentas:** CRM (permanencia, motivos de cancelamento), uso de produto, NPS/CSAT, registros de pos-venda.

---

## Mapa trava ↔ macroetapa

| Macroetapa | Travas |
|---|---|
| Aquisicao | Exposicao, Atencao |
| Engajamento | Interesse, Qualificacao |
| Monetizacao | Compromisso, Decisao |
| Retencao | Retencao |

## Aliases de numeracao (nao usar com o cliente)
...
| Qualificacao | T4 | Trava 4 | Trava 5 |
| Compromisso | T5 | Trava 3 | Trava 6 |
| Decisao | T6 | Trava 2 | Trava 7 |
| Retencao | T7 | Trava 1 | Trava 8 |
