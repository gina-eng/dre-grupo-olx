...
Se não encontrar informações sobre concorrência no dados/client.json, pergunte ao operador de uma vez:
...
1. Salve em `dados/outputs/ee-s1-swot.json` (com campo `summary` no topo)
